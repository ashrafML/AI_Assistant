...
pubmed = PubMed(tool="Haystack2.0Prototype", email="ashraf@gmail.com")
...
iface = gr.Interface(fn=ask, inputs=gr.Textbox(
    value="How are mRNA vaccines being used for cancer treatment?"), 
        outputs="markdown",  
        title="LLM Q&A Search Engine",
        description="Ask about BioMedical and get an answer from  AI assistant.",
